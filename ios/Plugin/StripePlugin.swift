...
public class StripePlugin: CAPPlugin {
    ...
    @objc func finalizePaymentSheet(_ call: CAPPluginCall) {
        self.paymentSheetExecutor.finalizePaymentSheet(call)
    }

    @objc func completeFinalizePaymentSheet(_ call: CAPPluginCall) {
        self.paymentSheetExecutor.completeFinalizePaymentSheet(call)
    }
